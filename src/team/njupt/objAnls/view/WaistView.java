 ...
 */
public class WaistView extends javax.swing.JFrame {
     ...
     */
    public WaistView(List<Float[]> vertexs_all,List<Float[]> vertexs_mid,List<Float[]> vertexs_after) {
...
//        	System.out.println(v[0]+","+v[1]+","+v[2]);
        	//俯视图
        	Line2D lin = new Line2D.Float(v[0]*1000+800,600-v[2]*1000,v[0]*1000+800,600-v[2]*1000);
        	//正视图
        	Line2D lin2 = new Line2D.Float(v[0]*1000+800,700-v[1]*1000,v[0]*1000+800,700-v[1]*1000);
        	g2.draw(lin);
        	g2.draw(lin2);
        }
        for(Float[] v : vertexs_after){
        	System.out.println(v[0]+","+v[1]+","+v[2]);
        	//俯视图
        	Line2D lin = new Line2D.Float(v[0]*1000+1200,600-v[2]*1000,v[0]*1000+1200,600-v[2]*1000);
        	//正视图
        	Line2D lin2 = new Line2D.Float(v[0]*1000+1200,700-v[1]*1000,v[0]*1000+1200,700-v[1]*1000);
        	g2.draw(lin);
        	g2.draw(lin2);
        }
    }
